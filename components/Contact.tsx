    ...
    <section className={styles.contact} id="about">
      ...
      <section className={styles.flex}>
        <div className={styles.photo}>
          <img src="/images/profile.png" alt="Portrait of Joao Rafael" />
        </div>
        <div className={styles.info}>
          ...
          <p className={styles.text}>
            Frontend Engineer with nearly 6 years of experience building large-scale products for Samsung Sidia, Localiza, Itau via Zup, and now ADP via Zallpy.
          </p>
          <p className={styles.text}>
            I specialize in Angular, React, TypeScript, Web Components and modern frontend architecture, with a strong focus on performance, scalability and maintainable systems.
          </p>
          <div className={styles.contactBlock} id="contact">
            <p className={styles.text}>
              I enjoy high-impact products, technical ownership and working across global teams in English, Portuguese and Spanish.
            </p>
